...
### 示例图
![示例图](https://raw.githubusercontent.com/zhanpple/colorPicker/master/files/ui_pre2.jpg "效果示例图")
### 代码使用
```java
     //Dialog 方式
...
```
### 示例图
![示例图](https://raw.githubusercontent.com/zhanpple/colorPicker/master/files/ui_pre3.png "效果示例图")
### 使用方法
```xml
