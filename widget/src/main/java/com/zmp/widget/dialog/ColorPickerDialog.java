...
public class ColorPickerDialog extends Dialog implements View.OnClickListener {
        ...
        private ColorPickerDialog(@NonNull Context context, int themeResId) {
        ...
        private void initGridView() {
                ...
                String colors = ColorSPUtils.getString(getContext(), ColorSPUtils.COLOR_KEY, "");
        ...
        public void onClick(View v) {
                ...
                if (i == R.id.bt_choose) {
                        try {
                                ...
                                ColorSPUtils.saveString(getContext(), ColorSPUtils.COLOR_KEY, toJson);
                                if (chooseListener != null) {
                                        chooseListener.choose(color);
                                }
                                cancel();
                        }
                        catch (Exception e) {
        ...
        public void setChooseListener(IChooseListener chooseListener) {
